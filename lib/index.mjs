    ...
    async managePrFiles() {
        ...
        if (changedFile) {
            ...
            if (!Array.isArray(data) && data.type === "file") {
                const fileContentText = Buffer.from(data.content, data.encoding === "base64" ? "base64" : "utf8").toString("utf8");
                const fileContent = JSON.parse(fileContentText);
...
async function checkEntries(gh_token, repo_owner, repo_name, pr_number) {
    const gh = new GithubPR(gh_token, repo_owner, repo_name, pr_number);
